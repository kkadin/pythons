...
# 연금저축 정보
list_pension =  [ 
                        # {'hold_num':118,    'name':"kodex_bank",      'number':'091170.KS', 'portion':  10},
                        # {'hold_num':150,    'name':"gold_h",          'number':'132030.KS', 'portion':  90},
                        {'hold_num':182,    'name':"tiger_SnP500_h",  'number':'143850.KS', 'portion': 18.0},
