...
# 보유 수량 입력
hold_of_kodex_bank = 199
hold_of_arirang_msci = 747
hold_of_tiger_SnP500 = 525
hold_of_kosef_nbond10y = 69
hold_of_kodex_sbond = 23

# 목표 비율
portion_of_kodex_bank = 5.0
portion_of_arirang_msci = 25.0
portion_of_tiger_SnP500 = 30.0
portion_of_kosef_nbond10y = 30.0
...
tiger_SnP500 = yf.download('360750.KS', start = day_start, end = day_end)
